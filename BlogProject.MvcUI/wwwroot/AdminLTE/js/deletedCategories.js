$(document).ready(function () {
    ...
    /* UndoDelete category start here. */
    ...
    $(document).on('click',
        ...
        function (event) {
            ...
            Swal.fire({
                ...
                text: `${categoryName} adlı kategori arşivden geri getirildi!`,
                icon: 'question',
    ...
    /* UndoDelete category ends here. */

    /* HardDelete category start here. */
